        ...
        <div className="flex-col">
            <div className="flex justify-center">
                <div className="xl:w-96">
                    <form className="input-group relative flex items-stretch w-full" onSubmit={(e)=>{e.preventDefault(); window.location.href=`?name=${query}`}}>
                        <input 
                            value={query}
                            ...
                            />
                        <button className="btn inlineBlock px-6 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700  focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out flex items-center" 
